...
class Shop(models.Model):
    ...
    log = models.ImageField(upload_to=f'shop_logo/', verbose_name='логотип магазина')
...
class GoodCart(models.Model):
    ...
    payment_flag = models.CharField(choices=payment_choices, max_length=1, default='n', verbose_name='статус')
